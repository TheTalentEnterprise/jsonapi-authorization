RSpec.shared_examples_for :relationship_operations do |namespace|
  ...
  describe "GET #{namespace}/articles/:id/relationships/comments" do
    ...
    subject(:last_response) { get("#{namespace}/articles/#{article.external_id}/relationships/comments") }
  ...
  describe "GET #{namespace}/articles/:id/relationships/author" do
    subject(:last_response) { get("#{namespace}/articles/#{article.external_id}/relationships/author") }
  ...
  describe "POST #{namespace}/articles/:id/relationships/comments" do
    ...
    subject(:last_response) { post("#{namespace}/articles/#{article.external_id}/relationships/comments", json) }
    let(:policy_scope) { Article.all }
    let(:comments_scope) { Comment.all }

    before do
      allow_any_instance_of(verify_namespace(CommentPolicy::Scope)).to receive(:resolve).and_return(comments_scope)
    end
  ...
  describe "PATCH #{namespace}/articles/:id/relationships/comments" do
    let(:article) { articles(:article_with_comments) }
    let(:new_comments) { Array.new(2) { Comment.new }.each(&:save) }
    let(:json) do
      <<-EOS.strip_heredoc
    ...
    subject(:last_response) { patch("#{namespace}/articles/#{article.external_id}/relationships/comments", json) }
    let(:policy_scope) { Article.all }
    let(:comments_scope) { Comment.all }
  ...
  describe "PATCH #{namespace}/articles/:id/relationships/author" do
    subject(:last_response) { patch("#{namespace}/articles/#{article.external_id}/relationships/author", json) }
    ...
    before do
      allow_any_instance_of(verify_namespace(UserPolicy::Scope)).to receive(:resolve).and_return(user_policy_scope)
    end
  ...
  describe "PATCH #{namespace}/tags/:id/relationships/taggable" do
    subject(:last_response) { patch("#{namespace}/tags/#{tag.id}/relationships/taggable", json) }
    ...
    before do
      allow_any_instance_of(verify_namespace(TagPolicy::Scope)).to receive(:resolve).and_return(tag_policy_scope)
      allow_any_instance_of(verify_namespace(CommentPolicy::Scope)).to receive(:resolve).and_return(comment_policy_scope)
    end
  ...
  describe "DELETE #{namespace}/articles/:id/relationships/comments" do
    let(:article) { articles(:article_with_comments) }
    ...
    subject(:last_response) { delete("#{namespace}/articles/#{article.external_id}/relationships/comments", json) }
    let(:policy_scope) { Article.all }
    let(:comments_scope) { Comment.all }
  ...
  describe "DELETE #{namespace}/articles/:id/relationships/author" do
    subject(:last_response) { delete("#{namespace}/articles/#{article.external_id}/relationships/author") }
