RSpec.shared_examples_for :included_resources do |namespace|
  ...
  describe "GET #{namespace}/articles" do
    subject(:last_response) { get("#{namespace}/articles?include=#{include_query}") }
  ...
  describe "GET #{namespace}/articles/:id" do
    ...
    subject(:last_response) { get("#{namespace}/articles/#{article.external_id}?include=#{include_query}") }
  ...
  describe "PATCH #{namespace}/articles/:id" do
    ...
    subject(:last_response) { patch("#{namespace}/articles/#{article.external_id}?include=#{include_query}", json) }
  ...
  describe "POST #{namespace}/articles/:id" do
    ...
    subject(:last_response) { post("#{namespace}/articles?include=#{include_query}", json) }
  ...
  describe "GET #{namespace}/articles/:id/articles" do
    let(:article) {
      Article.create(
        external_id: "indifferent_external_id",
        author: User.create(
  ...
  describe "GET #{namespace}/articles/:id/article" do
    let(:article) {
      Article.create(
        external_id: "indifferent_external_id",
        author: User.create(
    ...
    subject(:last_response) { get("#{namespace}/articles/#{article.external_id}/article?include=#{include_query}") }
